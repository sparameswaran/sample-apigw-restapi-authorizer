...
def authorize(event, context):
    ...
    # Refer to https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html
    ...
    context = {
        ...
        'boolKey': True,
        "stringKey": "stringval",
        "CustomPayload": "Testing for custom headers/payloads..",
        "CustomAuthorizationToken": "AccessTokenAfdasfd342432432423",
        "CustomAuthToken": "AccessTokenAfdasfd342432432423",
        "CustomToken1": "Token11Sample",
        "ApiKey": "testapikey33"
    }
    ...
    print('Final auth response:', authResponse)
...
class AuthPolicy(object):
    ...
    def _addMethod(self, effect, verb, resource, conditions):
        ...
        elif effect.lower() == 'deny' or effect.lower() == 'disallow':
